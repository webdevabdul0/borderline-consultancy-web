    ...
    <div className="flex flex-col w-full">
      ...
      <section className="py-12 bg-gray-900">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto gradient-card rounded-lg p-6 md:p-8 shadow-md border border-gray-700">
            <div className="prose max-w-none text-gray-200">
              <p className="text-sm text-gray-400 mb-6">Last Updated: May 13, 2023</p>
              
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-100 mb-4">1. Introduction</h2>
                <p className="text-gray-300">
                  Welcome to Borderline Visa Consultancy ("we," "our," or "us"). These Terms and Conditions govern your use of our visa consultancy services and website. By using our services, you agree to comply with and be bound by these terms. Please read them carefully.
                </p>
              </div>
              ...
              <div className="mb-8">
                ...
                <p className="mb-4 text-gray-300">
                  Borderline Visa Consultancy provides visa consultancy services for various Chinese visa categories, including business, study, family, and work visas. Our services include but are not limited to:
                </p>
              ...
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-100 mb-4">3. Client Responsibilities</h2>
                <p className="mb-4 text-gray-300">
                  As a client of Borderline Visa Consultancy, you agree to:
                </p>
                <ul className="list-disc pl-6 space-y-2 mb-4 text-gray-300">
              ...
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-100 mb-4">4. Fees and Payment</h2>
                <p className="mb-4 text-gray-300">
              ...
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-100 mb-4">5. Refund Policy</h2>
                <p className="mb-4 text-gray-300">
              ...
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-100 mb-4">6. Confidentiality and Privacy</h2>
                <p className="text-gray-300">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-300">
                  While we make every effort to ensure the success of your visa application, we cannot guarantee approval as the final decision rests with the immigration authorities. Borderline Visa Consultancy shall not be liable for any direct, indirect, incidental, special, or consequential damages resulting from the use of our services, including but not limited to visa denial, delays, or changes in immigration policies.
                </p>
              </div>
              
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-100 mb-4">8. Force Majeure</h2>
                <p className="text-gray-300">
                  Borderline Visa Consultancy shall not be liable for any failure or delay in performing our obligations where such failure or delay results from causes beyond our reasonable control, including but not limited to natural disasters, governmental actions, or other events that are unforeseeable and outside our control.
                </p>
              </div>
              
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-gray-100 mb-4">9. Amendments to Terms</h2>
                <p className="text-gray-300">
