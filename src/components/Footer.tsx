        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 pt-2">
              ...
              <a href="#" className="h-9 w-9 rounded-full bg-blue-600 flex items-center justify-center hover:bg-blue-500 animate-hover">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-300 hover:text-blue-300 text-sm animate-hover">Home</Link>
              </li>
              <li>
                <Link to="/services" className="text-gray-300 hover:text-blue-300 text-sm animate-hover">Services</Link>
              </li>
              <li>
                <Link to="/application-process" className="text-gray-300 hover:text-blue-300 text-sm animate-hover">Application Process</Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-300 hover:text-blue-300 text-sm animate-hover">Contact Us</Link>
              </li>
              <li>
                <Link to="/terms" className="text-gray-300 hover:text-blue-300 text-sm animate-hover">Terms & Conditions</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-300 text-sm">Chinese Business Visa</li>
              <li className="text-gray-300 text-sm">Chinese Study Visa</li>
              <li className="text-gray-300 text-sm">Family Visa</li>
              <li className="text-gray-300 text-sm">Work Visa</li>
            </ul>
          </div>
